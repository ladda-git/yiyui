...
{
    $main_id = $_GET['pj_id'];
    $sql_update = mysqli_query($conn,"UPDATE project_detail SET status = 1 WHERE pj_id = '$main_id' ");
}
?>
<style>
.gradient-custom {
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="text-end">
                                        <a <?php if($_SESSION['userunit_code']==1 || $_SESSION['admin'] == 6) echo "href='#addnewmodal_one'"; else echo "href='#'";?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="text-end">
                                        <a href="#addnewmodal_four" data-mdb-toggle="modal" title="เพิ่มข้อมูล">
                                            <!--<h3>278</h3>-->
                                            <p class="mb-0 font-weight-bold">เพิ่มข้อมูลที่เกี่ยวข้องกับหน่วยอื่น</p>
                                            <span
                                                class="badge rounded-pill badge-notification bg-danger"><?php echo $count;?></span>
                                        </a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="text-end">
                                        <a <?php if($_SESSION['userunit_code']==2 || $_SESSION['admin'] == 6) echo "href='#addnewmodal_two'"; else echo "href='#'";?>
                                            data-mdb-toggle="modal" title="เพิ่มข้อมูล">
                                            <!--<h3>278</h3>-->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="text-end">
                                        <a <?php if($_SESSION['userunit_code']==9 || $_SESSION['admin'] == 6) echo "href='#addnewmodal_four'"; else echo "href='#'";?>
                                            data-mdb-toggle="modal" title="เพิ่มข้อมูล">
                                            <!--<h3>278</h3>-->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="text-end">
                                        <a <?php if($_SESSION['userunit_code']==10 || $_SESSION['admin'] == 6) echo "href='#addnewmodal_five'"; else echo "href='#'";?>
                                            data-mdb-toggle="modal" title="เพิ่มข้อมูล">
                                            <!--<h3>278</h3>-->
...
-->
            ...
            $cnum=1;
            $sql_get=mysqli_query($conn,"SELECT pj_id, project_id,project_name,num_plan,name_tbudget,budget_limit FROM project_detail,budget_type WHERE project_detail.status = 1 AND project_detail.budget_typeid = budget_type.id_tbudget ");
                    while($main_result = mysqli_fetch_assoc($sql_get)):?>
                                    <tr>
                                        <th scope="row"><?php echo $cnum ++; ?></th>
                                        <td><?php echo nl2br($main_result['project_id']) ?></td>
                                        <td><?php echo nl2br($main_result['project_name']) ?></td>
                                        <td><?php echo $main_result['num_plan'] ?></td>
                                        <td><?php echo $main_result['name_tbudget']?></td>
                                        <td><?php echo $main_result['budget_limit']?></td>
                                        <td>
                                            <a href="#addnewmodal_uother" data-mdb-toggle="modal" class="add" title="เพิ่มข้อมูลต่อไป" data-toggle="tooltip">
                                            <i class="material-icons text-blue">&#xe146;</i></a>
                                                <a href="show_all.php?pj_id=<?php echo $main_result['pj_id']?>&project_code= <?php echo $main_result['project_id']?>" class="view" title="ดูรายละเอียด" data-toggle="tooltip"><i
