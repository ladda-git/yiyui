...
//$_SESSION['userunit_code'] = $userunit_code;
 global $userunit_c;
        $userunit_c=intval($_SESSION['userunit_code']);  	    	  
	  if (isset($_GET['userunit_c'])){
		 $userunit_c=intval($_GET['userunit_c']);       
	  }
      global $user_id;
            ...
            <section class="mb-4">
                <div class="card">
                    <div class="card-header py-3">
                        <h5 class="mb-0 text-center"><strong>Sales <?php echo $user_id.$userunit_c;?> </strong></h5>
                    </div>
                    <div class="card-body">
